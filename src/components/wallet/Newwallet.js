                    ...
                    <div className="col-md-12" style={{"textAlign": "center"}}>
                        ...
                        <div className="card-body">
                            <div className="row">
                                ...
                                <button className="btn btn-primary" style={{"marginTop": "20px"}} onSubmit={this.submit}>Confirm Payment</button>
                                </form>
                            </div>
                        </div>
                        </div>
...
export default createFragmentContainer(Newwallet, graphql`
    fragment Wallet_wallet on Newwallet{
        type
        bankname
        routingnumber
        accountnumber
